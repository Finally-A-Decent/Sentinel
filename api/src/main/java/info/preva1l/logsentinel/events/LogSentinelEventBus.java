...
import info.preva1l.logsentinel.events.annotations.Subscribe;
import info.preva1l.logsentinel.sanity.ApiSanityChecker;
 ...
 * @author Preva1l
 */
public final class LogSentinelEventBus {
    private static final LogSentinelEventBus INSTANCE = new LogSentinelEventBus();
     ...
     */
    public static LogSentinelEventBus instance() {
